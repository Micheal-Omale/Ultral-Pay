        ...
        <div class="bg-color-primary-dark relative">
            <div class="container py-10">
                <div class="grid gap-10 md:grid-cols-3 pb-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            <input type="text" class="w-3/4 text-color-gray bg-color-white px-4 py-4 lg:p-3 rounded-l-md focus:outline-none" placeholder="Enter Your Email">
                            
                            <button type="submit" class="bg-color-secondary px-4 py-4 lg:px-5 lg:py-3 rounded-r-md hover:opacity-90">
                ...
                <div class="flex justify-center pt-10 border-t border-color-gray">
                    <p>2023 &copy; UltraPay. All Rights Reserved.</p>
                </div>
            </div>
        </div>
     </section>
